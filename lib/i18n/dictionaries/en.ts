...
export const en = {
  ...
  sections: {
    ...
    packs: {
      sk: "Commercial packs",
      titleBefore: "Packages ",
      titleEmphasis: "ready",
      titleLine2: "to operate.",
      lede: "Products, programming, and service in one price.",
      currency: "MXN",
      priceNote: "*Price does not include VAT",
    ...
    cta: {
      ...
      titleEmphasis: "one tap away",
      titleAfter: ".",
      intro:
        "From 10 units to a full menu. Quote within 24 hours.",
      whatsappLabel: "WhatsApp",
      emailLabel: "Email",
      instagramLabel: "Instagram",
      copyHint: "copy",
      formTitleBefore: "Quote in ",
      formTitleEmphasis: "30 seconds",
      formTitleAfter: "",
      namePlaceholder: "Name",
      businessPlaceholder: "Business",
      interestPlaceholder: "What interests you?",
      detailPlaceholder: "Quantity, shapes, NFC destinations",
      submit: "Get quote",
      formNote: "Reply within 24 h",
