...
export const es = {
  ...
  sections: {
    ...
    packs: {
      ...
      titleBefore: "Paquetes ",
      titleEmphasis: "listos",
      titleLine2: "para operar.",
      lede: "Productos, programación y servicio en un solo precio.",
      currency: "MXN",
      priceNote: "*Precio no incluye IVA",
    ...
    cta: {
      titleBefore: "¿Tu marca ",
      titleEmphasis: "lista",
      titleAfter: " para un toque?",
      intro:
        "De 10 piezas a un menú completo. Cotización en 24 h.",
      whatsappLabel: "WhatsApp",
      emailLabel: "Correo",
      instagramLabel: "Instagram",
      copyHint: "copiar",
      formTitleBefore: "Cotiza en ",
      formTitleEmphasis: "30 segundos",
      formTitleAfter: "",
      namePlaceholder: "Nombre",
      businessPlaceholder: "Negocio",
      interestPlaceholder: "¿Qué te interesa?",
      detailPlaceholder: "Cantidad, formas, destinos NFC",
      submit: "Cotizar",
      formNote: "Respuesta en 24 h",
